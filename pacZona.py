...
def make_line_plot(state_dropdown, start_date, end_date):
    ...
    dfPAC_Zona = dfPAC_1.groupby(['Año/mes radicación solicitud beneficiario', 'ARG_CDESCRIPCION']).count().reset_index()
    dfPAC_Zona = dfPAC_Zona[dfPAC_Zona['Año/mes radicación solicitud beneficiario'] > 201712]
    dfPAC_Zona['Año/mes radicación solicitud beneficiario'] = ["_" + str(i) for i in dfPAC_Zona['Año/mes radicación solicitud beneficiario']]
    Scatter_fig = px.bar(dfPAC_Zona, x="Año/mes radicación solicitud beneficiario", y="MPC_NID", color="ARG_CDESCRIPCION")
