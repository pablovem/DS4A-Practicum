...
def make_line_plot(state_dropdown, start_date, end_date):
    ...
    dfPAC_municipio = dfPAC_1.groupby(['Año/mes radicación solicitud beneficiario', 'DIV_CNOM_MUNICIPIO']).count().reset_index()
    ...
    Scatter_fig = px.bar(dfPAC_municipio, x="Año/mes radicación solicitud beneficiario", y="MPC_NID",color="DIV_CNOM_MUNICIPIO")
